	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("#btn_security").click(function() {
				voice = "Indonesian Male";
				rate = 1;
				ruang = "<?php echo $nama_ruangan; ?>";
				ruang = ruang.toLowerCase();
				ruang = nama_ruang(ruang);
				if (panggil_melalui == "pc") {
					responsiveVoice.speak("<?php echo $panggilan->security; ?>", voice, {
						rate: rate,
						onstart: function() {
							$(".loader2").show();
						},
					...
					insert_panggilan("<?php echo $panggilan->security; ?>" + " ke " + ruang, "security", "<?php echo $nama_ruangan; ?>");
				}
			});
			...
			$("#btn_buka_sidang").click(function() {
				...
				rate = 1;
				if (panggil_melalui == "pc") {
					responsiveVoice.speak("<?php echo $panggilan->sidang; ?>", voice, {
						rate: rate,
						onstart: function() {
							$(".loader2").show();
						},
					...
					insert_panggilan("<?php echo $panggilan->sidang; ?>", "buka sidang", "<?php echo $nama_ruangan; ?>");
				}
			});
			// end buka sidang
			...
			$("#modal_pengumuman").click(function(){
				...
				{
					insert_panggilan(isi, "pengumuman", "<?php echo $nama_ruangan; ?>");
				}
			});
			// end pengumuman
		});
